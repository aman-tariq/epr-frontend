...
import { blogDropdown } from "@/lib/blog";
        ...
        <div className="container mx-auto px-4 lg:px-8 py-2">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* <a href="mailto:eprnexuss@gmail.com" className="flex items-center gap-2 text-sm text-primary-foreground/90 hover:text-primary-foreground transition-colors">
                <Mail size={14} />
                eprnexuss@gmail.com
              </a> */}
              {/* <a href="tel:+919220386699" className="flex items-center gap-2 text-sm text-primary-foreground/90 hover:text-primary-foreground transition-colors">
                <Phone size={14} />
                +91 92203 86699
              </a> */}
          ...
          <nav className="hidden lg:flex items-center gap-1" role="navigation" aria-label="Main navigation">
              ...
              <DropdownMenu open={isAboutOpen} onOpenChange={setIsAboutOpen}>
                ...
                >
                  <span className="inline-flex items-center gap-2">
                    About
                    {isAboutOpen ? (
                      <ChevronUp className="w-4 h-4 text-primary-foreground/90 transition-transform duration-200" />
                    ) : (
                      <ChevronDown className="w-4 h-4 text-primary-foreground/80 transition-transform duration-200" />
                    )}
                  </span>
                </DropdownMenuTrigger>
                <DropdownMenuContent
            ...
            >
              <DropdownMenu open={isBlogOpen} onOpenChange={setIsBlogOpen}>
                <DropdownMenuTrigger
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 inline-flex items-center justify-center gap-2 ${
        ...
        {isOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-4 flex flex-col gap-1">
                    ...
                    >
                      {aboutDropdown.map((item) => (
                        <Link
                          ...
                          className={`block px-4 py-3 rounded-lg text-sm font-medium transition-all ml-2 ${
                            location.pathname === "/about"
                              ? "bg-secondary/60 text-primary-foreground"
                              : "text-primary-foreground/80 hover:bg-primary-foreground/10"
                          }`}
                        >
                          {item.label}
                  ...
                  {mobileBlogOpen && (
                    ...
                    >
                      ...
                      <Link
                        to="/blog"
                        onClick={() => setIsOpen(false)}
                        className="block px-4 py-3 rounded-lg text-sm font-medium transition-all ml-2 text-primary-foreground/80 hover:bg-primary-foreground/10"
                      >
                        Blog home
                      </Link>
                    </motion.div>
                    ...
                    >
                      {serviceCategoriesNav.map((category) => (
                        <div key={category.name} className="pl-2">
                          <button
                            onClick={() => toggleCategory(category.name)}
                            className="w-full px-4 py-2 text-xs font-semibold text-secondary uppercase tracking-wider flex items-center justify-between hover:bg-primary-foreground/10 transition-colors rounded-lg"
                          >
                            <span>{category.name}</span>
                            <ChevronDown 
                              size={14} 
                      ...
                      <Link
                        to="/services"
                        onClick={() => setIsOpen(false)}
                        className="block px-4 py-3 rounded-lg text-sm font-medium transition-all ml-2 mt-2 border-t border-primary-foreground/10 pt-3 text-primary-foreground/80 hover:bg-primary-foreground/10"
                      >
                        All services
                      </Link>
                    </motion.div>
              ...
              <Link
                to="/contact"
                className="mt-2 px-5 py-3 bg-secondary text-primary-foreground font-semibold rounded-lg text-sm text-center"
              >
                Get Started
              </Link>
            </div>

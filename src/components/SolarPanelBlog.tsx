...
const staticStyles = `
  ...
  * { box-sizing: border-box; }
  ...
  .chart-head { display:flex; justify-content:space-between; gap:12px; flex-wrap:wrap; align-items:end; margin-bottom:14px; }
  ...
  .bar-col { flex:1; min-width:62px; text-align:center; }
  ...
  .table { width:100%; border-collapse:collapse; overflow:hidden; border-radius:20px; border:1px solid var(--line); }
  ...
  .cta { margin-top:18px; background: linear-gradient(135deg,#0f172a 0%, #102f4a 45%, #0f766e 100%); color:#fff; border-radius:32px; padding:28px; box-shadow:var(--shadow); text-align:center; }
  .cta h2 { margin:0 0 10px; font-size:28px; line-height:1.15; }
  .cta h2 em { font-style:normal; color:#fde68a; }
  .cta p { margin:0 auto 18px; max-width:820px; color:rgba(255,255,255,.88); }
  .btns { display:flex; justify-content:center; gap:10px; flex-wrap:wrap; }
  .btn { border:none; border-radius:14px; padding:13px 18px; font-weight:800; font-size:13px; cursor:pointer; }
  ...
  .sticky { position: sticky; bottom: 0; margin-top: 18px; display:flex; justify-content:space-between; gap:12px; align-items:center; flex-wrap:wrap; background:rgba(255,255,255,.88); backdrop-filter: blur(12px); border:1px solid rgba(219,227,239,.9); box-shadow:var(--shadow); border-radius:18px; padding:12px 14px; }
  .sticky strong { color: var(--accent); }
  ...
  @media (max-width: 900px) {
    .hero-grid, .grid, .cols, .kpis { grid-template-columns:1fr 1fr; }
  }
  @media (max-width: 680px) {
    .hero { padding:22px; }
    .hero-grid, .grid, .cols, .kpis { grid-template-columns:1fr; }
    .wrap { padding:14px; }
    .card, .chart-box, .case-body { padding:16px; }
...
/* FIX 1: Waste chart — scrollable on mobile */
.bar-wrap {
overflow-x: hidden;
...
.bar-col { min-width: 30px; flex-shrink: 0; }

/* FIX 2: Value database — stack rows vertically */
.db-row {
...
/* FIX 3: Composition table — horizontal scroll */
.table-wrap {
overflow-x: auto;
-webkit-overflow-scrolling: touch;
border-radius: 20px;
...
.cta h2 { font-size: 24px; }
  ...
  /* === IMPROVED TALK TO EXPERT STICKY === */
  .sticky-green {
    position: sticky;
    bottom: 20px;
    margin: 30px 0 20px;
  ...
  .btn-expert:hover {
    ...
    box-shadow: 0 15px 30px rgba(21, 128, 61, 0.35);
  ...
  @media (max-width: 680px) {
    ...
    //   bottom: 12px;
    // }
    .sticky-green{margin: 0; padding: 0;}
    .btn-expert {
      padding: 13px 20px;
      font-size: 13.5px;
    }
...
.btn-s:active {
  ...
  /* Your existing styles (charts, cards, etc.) */
  .bar-col { flex: 1; min-width: 58px; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 6px; }
  .bar { width: 100%; background: linear-gradient(180deg, #14b8a6, #0f766e); border-radius: 8px 8px 0 0; }

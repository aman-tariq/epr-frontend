        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="tel:+919773870268" className="flex items-center gap-2 text-sm text-primary-foreground/60 hover:text-secondary transition-colors">
                <Phone size={16} /> +91 97738 70268
              </a>

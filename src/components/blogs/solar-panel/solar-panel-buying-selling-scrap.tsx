// C:\Users\lenovo\Desktop\epr-nexuss\epr-nexus\frontend\src\components\blogs\solar-panel\solar-panel-buying-selling-scrap.tsx
...
const SolarPanelBuyingSellingScrap: React.FC = () => {
  ...
  return (
    ...
    <div className="blog-container font-['Poppins'] bg-gradient-to-b from-[#eff6ff] via-[#f8fafc] to-[#f4f7fb] text-[#1f2937] pb-12">
      ...
      {/* HERO */}
      <section className="hero relative overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#0f766e] to-[#f59e0b] text-white rounded-[30px] px-8 md:px-12 py-20 mb-8 shadow-2xl">
      ...
      <div className="grid lg:grid-cols-1 gap-6 mb-8">
        <section className="card bg-white rounded-3xl p-2 lg:p-8 shadow-xl border border-[#e5e7eb]">
          <h2 className="text-3xl font-bold mb-5 text-[#0f172a]">How we help clients in buying and selling scrap and products</h2>
        ...
        <section className="card bg-white rounded-3xl p-2 lg:p-8 shadow-xl border border-[#e5e7eb]">
          <h2 className="text-3xl font-bold mb-5 text-[#0f172a]">What clients usually need</h2>
          <p className="text-[#5b6472] mb-4">
      ...
      <section className="card bg-white rounded-3xl p-2 lg:p-8 shadow-xl border border-[#e5e7eb] mb-8">
        <h2 className="text-3xl font-bold mb-5 text-[#0f172a]">What we buy and what we help clients sell</h2>
          ...
          <table className="w-full table-auto min-w-full">
            <thead>
              <tr className="bg-[#0f172a] text-white">
                <th className="text-left px-6 py-4">Material / Product</th>
                <th className="text-left px-6 py-4">Buying support</th>
                <th className="text-left px-6 py-4">Selling support</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={i} className="border-t border-[#e5e7eb] hover:bg-[#f8fbff]">
                  <td className="px-6 py-5 font-medium break-words whitespace-normal">{material}</td>
                  <td className="px-6 py-5 text-[#5b6472] break-words whitespace-normal">{buying}</td>
                  <td className="px-6 py-5 text-[#5b6472] break-words whitespace-normal">{selling}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {/* Support Model Steps */}
      <section className="card bg-white rounded-3xl p-2 lg:p-8 shadow-xl border border-[#e5e7eb] mb-8">
        <h2 className="text-3xl font-bold mb-5 text-[#0f172a]">Our support model in simple steps</h2>
        <p className="text-[#5b6472] mb-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {[
            ...
            <div key={i} className="step border border-[#e5e7eb] rounded-2xl p-6 bg-gradient-to-b from-[#f8fbff] to-white">
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-8">
        <section className="card bg-white rounded-3xl p-2 lg:p-8 shadow-xl border border-[#e5e7eb]">
          <h2 className="text-2xl font-bold mb-4">Bar graph: where client value is created</h2>
          <p className="text-[#5b6472] mb-6">
          ...
          <p className="note mt-4">The stronger the match between material quality and market demand, the better the outcome for the client.</p>
        </section>

        <section className="card bg-white rounded-3xl p-2 lg:p-8 shadow-xl border border-[#e5e7eb]">
          <h2 className="text-2xl font-bold mb-4">Database view: trading dashboard</h2>
          <p className="text-[#5b6472] mb-6">A database-style summary helps clients understand the deal status at a glance.</p>
          ...
          <div className="mini-database grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="db-box border border-[#e5e7eb] rounded-2xl p-6 bg-gradient-to-b from-white to-[#f8fbff]">
      ...
      {/* Why Buy Smarter */}
      <section className="card bg-white rounded-3xl p-2 lg:p-8 shadow-xl border border-[#e5e7eb] mb-8">
        <h2 className="text-3xl font-bold mb-5 text-[#0f172a]">Why our guidance helps clients buy smarter</h2>
        <p className="text-[#5b6472] mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="font-semibold text-xl mb-3">Price discipline</h3>
            <p className="text-[#5b6472]">We support pricing decisions so clients do not chase volume at the cost of margin.</p>
            <h3 className="font-semibold text-xl mt-8 mb-3">Material clarity</h3>
            <p className="text-[#5b6472]">We help clients understand what they are actually buying.</p>
          </div>
          <div>
            <h3 className="font-semibold text-xl mb-3">Supplier confidence</h3>
            <p className="text-[#5b6472]">Our structured approach makes it easier to deal with suppliers.</p>
            <h3 className="font-semibold text-xl mt-8 mb-3">Operational fit</h3>
            <p className="text-[#5b6472]">We make sure the purchase matches the client’s plant capacity and downstream processing plan.</p>
          </div>
        </div>
      ...
      {/* Why Sell Better */}
      <section className="card bg-white rounded-3xl p-2 lg:p-8 shadow-xl border border-[#e5e7eb] mb-8">
        <h2 className="text-3xl font-bold mb-5 text-[#0f172a]">Why our guidance helps clients sell better</h2>
        <p className="text-[#5b6472] mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="font-semibold text-xl mb-3">Higher buyer trust</h3>
            <p className="text-[#5b6472]">Buyers respond better when the material is well sorted and easy to verify.</p>
            <h3 className="font-semibold text-xl mt-8 mb-3">Better product positioning</h3>
            <p className="text-[#5b6472]">We help clients place each output into the correct channel.</p>
          </div>
          <div>
            <h3 className="font-semibold text-xl mb-3">Faster closure</h3>
            <p className="text-[#5b6472]">Clear product information shortens negotiation time.</p>
            <h3 className="font-semibold text-xl mt-8 mb-3">Improved reputation</h3>
            <p className="text-[#5b6472]">When clients sell consistently and transparently, they build a strong reputation.</p>
          </div>
        </div>
      </section>

      {/* Tracking Dashboard Table */}
      <section className="card bg-white rounded-3xl p-8 lg:p-8 shadow-xl border border-[#e5e7eb] mb-8">
        <h2 className="text-3xl font-bold mb-5 text-[#0f172a]">Tracking dashboard for buying and selling</h2>
        <p className="text-[#5b6472] mb-6">
          ...
          <table className="w-full table-auto min-w-full">
            <thead>
              <tr className="bg-[#0f172a] text-white">
                ...
                <th className="text-left px-6 py-4">Market path</th>
                <th className="text-left px-6 py-4">Expected outcome</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <tr key={i} className="border-t border-[#e5e7eb] hover:bg-[#f8fbff]">
                  <td className="px-6 py-5 font-medium break-words whitespace-normal">{item}</td>
                  <td className="px-6 py-5 text-[#5b6472] break-words whitespace-normal">{source}</td>
                  <td className="px-6 py-5 text-[#5b6472] break-words whitespace-normal">{path}</td>
                  <td className="px-6 py-5 text-[#5b6472] break-words whitespace-normal">{outcome}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {/* Case Study */}
      <section className="card case-study bg-gradient-to-br from-[#fff7ed] to-[#ffedd5] border border-[#fdba74] rounded-3xl p-2 lg:p-8 shadow-xl mb-8">
        <h2 className="text-3xl font-bold mb-5 text-[#9a3412]">Case study: helping a client turn mixed solar scrap into a revenue stream</h2>
      ...
      {/* CLOSING */}
      <section className="closing text-white text-center bg-gradient-to-br from-[#0f172a] via-[#0f766e] to-[#f97316] py-16 rounded-[30px]">
        ...
        <div className="final-line mt-10 text-3xl font-bold">“We help clients buy with confidence and sell with value.”</div>
      </section>

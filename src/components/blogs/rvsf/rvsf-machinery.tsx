...
:root{--navy:#0a1628;--navy-mid:#0f2044;--navy-soft:#1a3260;--navy-card:#112238;--blue:#1e4fac;--blue-bright:#2563eb;--sky:#38bdf8;--sky-pale:#e0f2fe;--silver:#cbd5e1;--silver-dim:#94a3b8;--white:#ffffff;--offwhite:#f0f4fb;--text-body:#334155;--text-soft:#64748b;--accent:#f59e0b;--accent-pale:#fef3c7;--teal:#0d9488;--teal-pale:#ccfbf1;--red:#dc2626;--red-pale:#fee2e2;--green:#16a34a;--green-pale:#dcfce7;--border:rgba(255,255,255,0.09)}
.machinery-blog-root{font-family:'Inter',sans-serif;background:var(--offwhite);color:var(--text-body);line-height:1.75;font-size:16px}
.hero{background: linear-gradient(160deg, var(--navy) 0%, var(--navy-mid) 55%, #0d2d5e 100%);padding:88px 40px 80px;position:relative;overflow:hidden;text-align:center}
...
.hero-glow{position:absolute;top:-120px;left:50%;transform:translateX(-50%);width:700px;height:400px;background:radial-gradient(ellipse at center,rgba(37,99,235,0.22) 0%,transparent 70%);pointer-events:none}
...
.hero h1{font-family:'Bebas Neue',sans-serif;font-size:clamp(44px,7vw,82px);color:var(--white);line-height:1.0;max-width:820px;margin:0 auto 10px;letter-spacing:1px;position:relative}
.hero h1 .accent{color:var(--sky)}
.hero-sub{font-family:'Lora',serif;font-size:clamp(16px,2vw,20px);font-weight:400;font-style:italic;color:rgba(255,255,255,0.65);max-width:620px;margin:14px auto 44px;line-height:1.65;position:relative}
...
.h-stat .num{display:block;font-family:'Bebas Neue',sans-serif;font-size:46px;color:var(--sky);line-height:1}
...
.container{margin:0 auto;padding:0 28px}
...
.s-title{font-family:'Bebas Neue',sans-serif;font-size:clamp(30px,4vw,46px);color:var(--navy);line-height:1.1;margin-bottom:18px;letter-spacing:0.5px}
...
.pull-quote{border-left:4px solid var(--blue-bright);padding:16px 24px;background:var(--sky-pale);border-radius:0 8px 8px 0;font-family:'Lora',serif;font-size:18px;font-style:italic;color:var(--navy-soft);margin:32px 0;line-height:1.65}
.chart-card{background:var(--white);border:1px solid var(--line);border-radius:14px;padding:32px;margin:36px 0;box-shadow:0 4px 20px rgba(10,22,40,0.06)}
.chart-card h3{font-family:'Bebas Neue',sans-serif;font-size:22px;color:var(--navy);margin-bottom:4px;letter-spacing:0.5px}
.chart-card .c-sub{font-size:13px;color:var(--text-soft);margin-bottom:22px}
.chart-wrap{position:relative;width:100%;height:300px}
.legend-row{display:flex;flex-wrap:wrap;gap:16px;margin-bottom:14px;font-size:12px;color:var(--text-soft)}
.ld{width:10px;height:10px;border-radius:2px;display:inline-block;margin-right:5px;vertical-align:middle}
.tbl-wrap{background:var(--white);border:1px solid #dde3ef;border-radius:14px;overflow:hidden;margin:36px 0;box-shadow:0 4px 16px rgba(10,22,40,0.05)}
...
.srv-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:22px;margin:36px 0}
...
.proc-list{display:flex;flex-direction:column;gap:0;margin:36px 0;position:relative}.proc-list::before{content:'';position:absolute;left:22px;top:28px;bottom:28px;width:2px;background:#dde3ef}
.proc-step{display:flex;gap:22px;align-items:flex-start;padding:18px 0;position:relative}
...
.case-wrap{background:linear-gradient(135deg,var(--navy) 0%,var(--navy-mid) 100%);border-radius:24px;padding:28px;box-shadow:0 18px 36px rgba(15,36,80,0.18);position:relative;overflow:hidden;color:#fff}
.case-wrap::after{content:'❝';position:absolute;top:-12px;right:36px;font-size:180px;color:rgba(255,255,255,0.04);font-family:serif;line-height:1}
...
.case-wrap h3{font-family:'Bebas Neue',sans-serif;font-size:28px;color:var(--white);letter-spacing:0.5px;margin-bottom:14px}
.case-wrap p{color:rgba(255,255,255,0.72)}
.case-metrics{display:flex;gap:36px;flex-wrap:wrap;margin-top:32px;padding-top:28px;border-top:1px solid rgba(255,255,255,0.12)}
.cm .val{display:block;font-family:'Bebas Neue',sans-serif;font-size:40px;color:var(--sky);line-height:1;margin-bottom:6px}
...
.faq-list{margin:36px 0}.faq-item{background:var(--white);border:1px solid #dde3ef;border-radius:12px;margin-bottom:14px;overflow:hidden;box-shadow:0 2px 8px rgba(10,22,40,0.04)}
.faq-q{display:flex;align-items:flex-start;gap:16px;padding:22px 24px;cursor:pointer}
...
.faq-q-text{font-family:'Bebas Neue',sans-serif;font-size:18px;color:var(--navy);letter-spacing:0.3px;line-height:1.3;flex:1;margin-top:4px}
.faq-a{padding:0 24px 22px 70px;font-size:14.5px;color:var(--text-soft);line-height:1.75}
.cta-block{background:linear-gradient(135deg,var(--navy) 0%,var(--navy-soft) 100%);border-radius:18px;padding:60px 48px;text-align:center;margin:60px 0;position:relative;overflow:hidden}
...
.cta-block h2{font-family:'Bebas Neue',sans-serif;font-size:clamp(28px,4vw,46px);color:var(--white);margin-bottom:14px;letter-spacing:0.5px;position:relative}
.cta-block p{color:rgba(255,255,255,0.62);max-width:500px;margin:0 auto 32px;position:relative;font-size:15px}
.cta-btn{display:inline-block;background:linear-gradient(90deg,var(--blue-bright),var(--sky));color:var(--white);padding:15px 44px;border-radius:6px;font-weight:600;font-size:15px;text-decoration:none;letter-spacing:0.5px;position:relative;box-shadow:0 4px 20px rgba(37,99,235,0.4)}
.intro-strip{background:linear-gradient(135deg,var(--navy),var(--navy-soft));border-radius:12px;padding:28px 32px;margin:32px 0;font-family:'Lora',serif;font-size:18px;font-style:italic;color:rgba(255,255,255,0.85);line-height:1.7;border-left:4px solid var(--sky)}
.metrics-row{display:grid;grid-template-columns:repeat(auto-fit,minmax(170px,1fr));gap:16px;margin:32px 0}.metric-box{background:var(--white);border:1px solid var(--line);border-radius:12px;padding:22px 18px;text-align:center;box-shadow:0 2px 8px rgba(10,22,40,0.04)}
.metric-box .mv{font-family:'Bebas Neue',sans-serif;font-size:36px;color:var(--navy);line-height:1;margin-bottom:6px}
.metric-box .ml{font-size:12px;color:var(--text-soft);font-weight:500}
.footer{background:var(--navy);color:rgba(255,255,255,0.35);text-align:center;padding:32px 24px;font-size:12.5px}
@media(max-width:600px){.hero{padding:60px 20px 52px}.hero-stats{gap:28px}.case-wrap{padding:32px 22px}.cta-block{padding:42px 24px}.faq-a{padding-left:24px}}
`;
  ...
  useEffect(() => {
      ...
      charts.push(new Chart(c1Ref.current.getContext('2d') as CanvasRenderingContext2D, {
        ...
        options: {
          ...
          scales: {
            ...
            y: { grid: { color: 'rgba(0,0,0,0.04)' }, ticks: { font: { size: 12 }, callback: (v: any) => `₹${v}L` } },
          },
        } as any,
      }));
    }
    ...
    if (c2Ref.current?.getContext('2d')) {
      charts.push(new Chart(c2Ref.current.getContext('2d') as CanvasRenderingContext2D, {
        ...
        data: {
          ...
          datasets: [
            { label: 'Reactive', data: [61, 58, 64, 70, 72, 65], borderColor: '#94a3b8', borderDash: [5, 4], backgroundColor: 'rgba(148,163,184,0.1)', pointBackgroundColor: '#94a3b8', pointRadius: 4, borderWidth: 2 },
            { label: 'Preventive', data: [94, 91, 89, 96, 98, 88], borderColor: '#1e4fac', backgroundColor: 'rgba(30,79,172,0.1)', pointBackgroundColor: '#1e4fac', pointRadius: 4, borderWidth: 2.5 },
          ],
        },
        options: {
          responsive: true,
          maintainAspectRatio: false,
          plugins: { legend: { display: false } },
          scales: { r: { min: 40, max: 100, ticks: { stepSize: 20, font: { size: 11 }, backdropColor: 'transparent' }, grid: { color: 'rgba(0,0,0,0.07)' }, pointLabels: { font: { size: 11 } } } },
        } as any,
      }));
    }
    ...
    if (c3Ref.current?.getContext('2d')) {
      ...
      charts.push(new Chart(c3Ref.current.getContext('2d') as CanvasRenderingContext2D, {
        ...
        data: {
          ...
          datasets: [
            { label: 'Investment', data: invest, borderColor: '#dc2626', borderDash: [6, 3], backgroundColor: 'transparent', pointBackgroundColor: '#dc2626', pointRadius: 3, borderWidth: 2 },
            { label: 'Savings', data: saves, borderColor: '#0d9488', fill: true, backgroundColor: 'rgba(13,148,136,0.07)', pointBackgroundColor: '#0d9488', pointRadius: 3, borderWidth: 2.5 },
            { label: 'Net Benefit', data: net, borderColor: '#1e4fac', backgroundColor: 'transparent', pointBackgroundColor: '#1e4fac', pointRadius: 3, borderWidth: 2.5 },
          ],
        },
        options: {
          responsive: true,
          ...
          scales: {
            ...
            y: { grid: { color: 'rgba(0,0,0,0.04)' }, ticks: { font: { size: 11 }, callback: (v: any) => `₹${v}L` } },
          },
        } as any,
      }));
    }
      ...
      charts.push(new Chart(c4Ref.current.getContext('2d') as CanvasRenderingContext2D, {
        ...
        options: {
          ...
          scales: {
            ...
            y: { grid: { color: 'rgba(255,255,255,0.06)' }, ticks: { color: 'rgba(255,255,255,0.5)', font: { size: 11 } }, min: 200 },
          },
        } as any,
      }));
    }
    ...
    if (c5Ref.current?.getContext('2d')) {
      charts.push(new Chart(c5Ref.current.getContext('2d') as CanvasRenderingContext2D, {
        type: 'bar',
        data: {
          labels: ['Machine Uptime >90%', 'Planned Maintenance Program', 'Recovery Rate >85%', 'Compliance Score >90', 'IoT Monitoring Active', 'Certified Staff >80%'],
          datasets: [
        ...
        options: {
          ...
          plugins: { legend: { display: false } },
          scales: {
            x: { grid: { color: 'rgba(0,0,0,0.04)' }, ticks: { font: { size: 11 }, callback: (v: any) => `${v}%` }, max: 100 },
  ...
  return (
    <div className="machinery-blog-root">
      <Seo
        ...
        keywords={[
          "RVSF Machinery Maintenance",
          "Vehicle Scrapping Plant Support",
          "Shredder Maintenance",
          "RVSF Preventive Maintenance",
          "Registered Vehicle Scrapping Facility Services",
          "RVSF Equipment Repair",
          "IoT Monitoring for RVSF",
          "Scrap Plant Machinery Support"
        ]}
      ...
      <main>
        <section className="section">
          <div className="container">
            ...
            <div className="metrics-row">
              <div className="metric-box"><div className="mv">800<span>+</span></div><div className="ml">Active RVSF plants in India (2025)</div></div>
              <div className="metric-box"><div className="mv">62<span>%</span></div><div className="ml">Plants without structured maintenance</div></div>
              <div className="metric-box"><div className="mv">₹18<span>L</span></div><div className="ml">Avg. loss per shredder failure event</div></div>
              <div className="metric-box"><div className="mv">3.8<span>hr</span></div><div className="ml">Our avg. emergency repair time</div></div>
            </div>
          </div>
        </section>
          ...
          <section className="section">
            <div className="container">
              ...
              <div className="chart-card">
                ...
                <p className="c-sub">Values in ₹ Lakhs — based on survey of 120 registered RVSF facilities, 2023–2024</p>
                <div className="legend-row">
                    <span><span className="ld" style={{ background: '#1e4fac' }}></span>Revenue Lost (₹L)</span>
                    <span><span className="ld" style={{ background: '#0d9488' }}></span>Repair Cost (₹L)</span>
                    <span><span className="ld" style={{ background: '#f59e0b' }}></span>Compliance Penalty Risk (₹L)</span>
                </div>
        ...
        <section className="section">
          <div className="container">
            ...
            <div className="s-bar" />
            <p>Our work is not generic industrial maintenance repackaged with a different logo. Every service we offer has been designed around the specific machines, regulatory requirements, throughput pressures, and operational realities of registered vehicle scrapping and recycling facilities. These four pillars form the backbone of every client engagement.</p>
            <div className="srv-grid">
              <div className="srv-card"><div className="srv-top" /><div className="srv-icon">⚙️</div><h4>Preventive Maintenance Programs</h4><p>Scheduled service visits, fluid and wear-part analysis, replacement cycles, and monthly health reports — calibrated precisely to your machine hours, load profiles, and throughput volumes.</p></div>
              <div className="srv-card"><div className="srv-top" /><div className="srv-icon">🔧</div><h4>Emergency Breakdown Response</h4><p>A dedicated on-call engineering team with guaranteed response windows. Critical spare parts stocked locally for the top 28 failure scenarios specific to RVSF machinery environments.</p></div>
              <div className="srv-card"><div className="srv-top" /><div className="srv-icon">📡</div><h4>IoT Performance Monitoring</h4><p>Real-time sensor data from vibration, temperature, and load points across your critical machines — all flowing to a live dashboard your team and ours watch simultaneously.</p></div>
              <div className="srv-card"><div className="srv-top" /><div className="srv-icon">📋</div><h4>Compliance & Audit Readiness</h4><p>Complete digital service history, MoRTH-aligned documentation, and pre-inspection machinery reviews — so audit day is never a surprise and your license is never at risk.</p></div>
            </div>
          </div>
        </section>
        ...
        <div className="section-alt">
          <section className="section">
            <div className="container">
              ...
              <div className="s-bar" />
              <p>Across 85 RVSF facilities that transitioned from reactive to preventive maintenance programs over a 24-month period, the improvement in every key operational metric was consistent, significant, and lasting. These are real outcomes — not modelled projections.</p>
              <div className="chart-card">
                ...
                <div className="legend-row">
                    <span><span className="ld" style={{ background: '#94a3b8', border: '1px dashed #64748b' }}></span>Reactive Maintenance (Before)</span>
                    <span><span className="ld" style={{ background: '#1e4fac' }}></span>Preventive Maintenance (After)</span>
                </div>
        ...
        <section className="section">
          <div className="container">
            ...
            <div className="s-bar" />
            <p>One of the most impactful tools in our support model is a structured, live machine health database. Instead of paper logbooks and operator guesswork, we build and maintain a real-time digital record for every critical machine in your plant. Every service event, wear reading, sensor alert, and inspection note is captured, timestamped, and accessible. The table below represents the kind of clarity our clients have at their fingertips every single day.</p>
            <div className="tbl-wrap">
              <table>
                ...
                <tbody>
                  ...
                  <tr><td><strong>Magnetic Drum Separator</strong></td><td>22 Nov 2024</td><td>290 hrs</td><td>In 1,210 hrs</td><td>Very low</td><td><span className="badge bg">Healthy</span></td></tr>
                  <tr><td><strong>Fluid Draining Station</strong></td><td>10 Oct 2024</td><td>960 hrs</td><td>In 540 hrs</td><td>Medium — pump seal review needed</td><td><span className="badge ba">Schedule Soon</span></td></tr>
                </tbody>
              </table>
            </div>
            <p>This level of visibility eliminates the two most common failure modes in scrapping plant operations: forgotten service windows and missed early-warning signals. When your operations team can see the full health picture at a glance, every maintenance decision becomes faster, smarter, and impossible to second-guess during an audit.</p>
          </div>
        </section>
        ...
        <div className="section-alt">
          <section className="section">
            <div className="container">
              ...
              <div className="s-bar" />
              <p>We know machinery support feels like a cost centre until it isn't. So here's what the numbers look like across 42 mid-sized RVSF client facilities (processing 800–1,200 vehicles per month) tracked over three full years of engagement with us.</p>
              <div className="chart-card">
                <h3>Cumulative Investment vs. Cumulative Savings Over 36 Months (₹ Lakhs)</h3>
                <p className="c-sub">Median outcomes tracked across 42 client plants — break-even typically reached at month 8</p>
                <div className="legend-row">
                    <span><span className="ld" style={{ background: '#dc2626', border: '1px dashed #dc2626' }}></span>Cumulative Support Investment</span>
                    <span><span className="ld" style={{ background: '#0d9488' }}></span>Cumulative Savings Realised</span>
                    <span><span className="ld" style={{ background: '#1e4fac' }}></span>Net Benefit Position</span>
                  </div>
              ...
              <p>Break-even typically arrives between months 7 and 10. From that point forward, every month of the partnership generates more measurable value than it costs. By the end of year three, the average plant partner is carrying a net financial benefit of ₹1.85 crores — money that would previously have disappeared into emergency repairs, lost production shifts, and compliance penalties.</p>
            </div>
          </section>
        </div>
        ...
        <section className="section">
          <div className="container">
            ...
            <div className="s-bar" />
            <p>We designed our onboarding process so that every new plant partner reaches full support coverage within 14 working days — with zero disruption to your ongoing operations at every step.</p>
            <div className="proc-list">
              <div className="proc-step"><div className="p-num">1</div><div className="p-body"><h4>Plant Audit & Full Machine Census</h4><p>Our engineers visit your facility and document every machine — model, age, operating hours, service history, current condition, and daily load. We build your machine database from scratch if no records exist.</p></div></div>
              <div className="proc-step"><div className="p-num">2</div><div className="p-body"><h4>Risk Stratification & Priority Mapping</h4><p>Using audit data, every machine is classified by failure probability and business impact. High-risk, high-impact units go onto an immediate watchlist with enhanced monitoring from day one.</p></div></div>
              <div className="proc-step"><div className="p-num">3</div><div className="p-body"><h4>12-Month Maintenance Calendar Deployment</h4><p>A forward maintenance schedule is built and shared with your operations team. Every service window is planned around your production calendar to eliminate throughput disruption.</p></div></div>
              <div className="proc-step"><div className="p-num">4</div><div className="p-body"><h4>IoT Sensor Installation on Critical Machines</h4><p>Vibration, temperature, and load sensors go onto your highest-risk machines — shredders, separators, and balers first. Real-time data begins flowing to your dashboard and our monitoring centre immediately.</p></div></div>
              <div className="proc-step"><div className="p-num">5</div><div className="p-body"><h4>Staff Training & SOP Handover</h4><p>Your in-house team receives hands-on training on daily machine checks, early-warning signal recognition, and emergency escalation protocols — empowering your people, not creating dependency on ours.</p></div></div>
              <div className="proc-step"><div className="p-num">6</div><div className="p-body"><h4>Live Monitoring, Monthly Reports & Quarterly Reviews</h4><p>You get dashboard access, monthly machine health reports, and quarterly in-person reviews. We adjust service plans as your throughput grows, your machine hours accumulate, or your operational priorities shift.</p></div></div>
            </div>
          </div>
        </section>
        ...
        <div className="section-alt">
          <section className="section">
            <div className="container">
              ...
              <div className="s-bar" />
              <p>Numbers tell part of the story. Here is one of our most challenging — and ultimately most rewarding — client partnerships, told as it actually happened.</p>
              <div className="case-wrap">
                <div className="case-tag">📍 Case Study — Pune, March 2023 to October 2024</div>
                <h3>EcoScrap Recyclers Pvt. Ltd. — Pune Industrial Zone</h3>
                <p>When EcoScrap reached out to us in March 2023, they were processing just 340 vehicles a month against a licensed capacity of 900. Their primary shredder had failed twice in the preceding four months. Their eddy current separator was producing inconsistent aluminium recovery output. And a government compliance inspection was scheduled six months away — in September — giving them a hard deadline to get the plant in order.</p>
                <p style={{ marginTop: '14px' }}>The plant manager described the situation plainly: <em style={{ color: 'rgba(255,255,255,0.88)' }}>&quot;We were spending more time reacting to breakdowns than actually processing vehicles. Every week felt like a crisis we were just managing to survive.&quot;</em></p>
                <p style={{ marginTop: '14px' }}>Within 60 days of engagement, we replaced the shredder hammer assembly, overhauled the separator's bearing system, and installed IoT vibration sensors on four critical machines. By September, the plant passed its compliance inspection with a commendation from the regional RVSF authority. By December, monthly throughput had crossed 700 vehicles. By October 2024, EcoScrap was running at 897 vehicles per month — just shy of full licensed capacity.</p>
                <div className="case-metrics">
                  <div className="cm"><span className="val">+164%</span><span className="lbl">throughput increase</span></div>
                  <div className="cm"><span className="val">₹1.2Cr</span><span className="lbl">savings in 18 months</span></div>
                  <div className="cm"><span className="val">Zero</span><span className="lbl">compliance penalties</span></div>
                  <div className="cm"><span className="val">97.3%</span><span className="lbl">machine uptime by month 12</span></div>
                </div>
        ...
        <section className="section">
          <div className="container">
            ...
            <div className="s-bar" />
            <p>India's vehicle scrapping sector is young, fast-scaling, and still finding its operational footing. Understanding where the average plant sits today — against where best-practice benchmarks set the bar — clarifies exactly why machinery support is not optional for any facility serious about long-term growth and stability.</p>
            <div className="chart-card">
              <h3>RVSF Plant Performance Benchmarks — Current Achievment vs. Best-Practice Targets</h3>
              <p className="c-sub">% of plants achieving each benchmark — RVSF industry surveys & operator data, 2024</p>
              <div className="legend-row">
                <span><span className="ld" style={{ background: '#1e4fac' }}></span>% Plants Currently Achieving</span>
                <span><span className="ld" style={{ background: 'rgba(245,158,11,0.35)', border: '1px dashed #f59e0b' }}></span>Best-Practice Target</span>
              </div>
            ...
            <p>The IoT monitoring figure is the starkest: only 18 in every 100 plants currently has any form of real-time machine monitoring in place. Fewer than one in three follows a structured preventive maintenance plan. These are not technology failures — they are knowledge and support gaps that any plant can close within weeks with the right partner alongside them.</p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div className="cta-block">
              ...
              <p>Get a no-obligation plant machinery audit and discover exactly where your biggest risks — and your biggest cost savings — are hiding right now.</p>

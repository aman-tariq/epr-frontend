...
/* Main Layout */
.wrap{width:min(1140px, calc(100% - 32px));margin:0 auto;padding:34px 0 60px;display:grid;grid-template-columns:1fr;gap:24px;align-items:start}
@media(min-width:1024px){
  .wrap{grid-template-columns:2.75fr 1.25fr}
}

.main-content-area{display:flex;flex-direction:column;gap:26px;min-width:0}

/* STICKY SIDEBAR - Clean Version */
.sidebar-column{
  display:none;
}
@media(min-width:1024px){
...
.mobile-form-container{display:block;margin:24px 0}
@media(min-width:1024px){
  .mobile-form-container{display:none}
}
...
h2{font-size:clamp(24px,3.5vw,36px);line-height:1.18;margin:40px 0 14px;letter-spacing:-.02em}
h3{font-size:20px;margin:0 0 10px;color:var(--blue-4)}
p{color:#274862;margin:0 0 16px}

.two-col{display:grid;grid-template-columns:1fr;gap:18px;align-items:start}
@media(min-width:768px){.two-col{grid-template-columns:1.08fr .92fr}}

.card{background:var(--card);border:1px solid var(--line);border-radius:22px;box-shadow:var(--shadow);padding:24px}
.chart-card{padding:20px 20px 12px}
.chart-title{display:flex;justify-content:space-between;gap:10px;align-items:flex-end;margin-bottom:14px}
.chart-title small{color:var(--muted);font-size:12px;text-transform:uppercase;letter-spacing:.08em;font-weight:700}
...
.pill{background:var(--soft);border:1px solid #cfe2f4;color:#2b5f92;border-radius:999px;padding:8px 12px;font-size:12px;font-weight:700}

.phase{border-left:5px solid var(--blue);background:linear-gradient(180deg, #ffffff, #fbfdff)}
.phase .num{width:42px;height:42px;display:grid;place-items:center;border-radius:12px;background:linear-gradient(135deg, var(--blue), var(--blue-2));color:#fff;font-weight:900;margin-bottom:12px}
.phase p{margin:0;color:#4e6983}

.table-responsive{width:100%;overflow-x:auto;-webkit-overflow-scrolling:touch;border-radius:18px;border:1px solid var(--line)}
table{width:100%;border-collapse:collapse;min-width:620px}
thead th{background:linear-gradient(135deg, var(--blue-4), var(--blue));color:#fff;text-align:left;padding:14px 14px;font-size:12px;letter-spacing:.08em;text-transform:uppercase}
tbody td{padding:14px 14px;border-bottom:1px solid var(--line);vertical-align:top;color:#2a4862}tbody tr:nth-child(even){background:#f8fbff}

.badge.green{background:#e6f7ef;color:#116642}.badge.blue{background:#e6f2ff;color:#0b5cab}.badge.amber{background:#fff4da;color:#9b6500}

.case{background:linear-gradient(135deg, #0e3f7a 0%, #1e66d0 55%, #4ea1ff 100%);color:#fff;border-radius:24px;padding:28px;box-shadow:var(--shadow);position:relative;overflow:hidden}
.case::after{content:"CASE STUDY";position:absolute;right:-46px;top:28px;background:rgba(255,255,255,.16);color:#fff;font-size:10px;letter-spacing:.32em;font-weight:800;padding:7px 64px;transform:rotate(90deg);transform-origin:right top}
.case h3{color:#fff}.case p{color:rgba(255,255,255,.9)}
.case-grid{display:grid;grid-template-columns:1fr;gap:14px;margin-top:18px}
@media(min-width:640px){.case-grid{grid-template-columns:repeat(3,1fr)}}

.faq{margin-top:16px}.faq-item{border-bottom:1px solid var(--line);padding:16px 0}
.faq-q{display:flex;justify-content:space-between;gap:12px;align-items:center;cursor:pointer;font-weight:800;color:#173552}
.faq-q::after{content:"+";color:var(--blue);font-size:26px;line-height:1;flex-shrink:0}
.faq-q.open::after{content:"×"}
.faq-a{display:none;margin-top:12px;color:#55708a}
.faq-a.show{display:block}

.callout{background:linear-gradient(135deg, #eff7ff, #ffffff);border:1px solid #cfe2f4;border-left:6px solid var(--blue);border-radius:18px;padding:18px 20px;color:#33516c;font-style:italic}

.footer-cta{background:linear-gradient(135deg, #0e3f7a, #1e66d0);color:#fff;border-radius:24px;padding:28px;text-align:center;box-shadow:var(--shadow)}
.footer-cta h2{margin-top:0;color:#fff;font-size:clamp(22px,3.5vw,32px)}
.footer-cta p{color:rgba(255,255,255,0.86);max-width:760px;margin:0 auto}

/* Mobile */
@media(max-width:960px){.stats,.two-col,.grid-3,.case-grid{grid-template-columns:1fr 1fr}}
@media(max-width:720px){
  .wrap{width:min(100% - 16px, 1140px);padding:20px 0 40px}
  .hero{padding:62px 16px 48px}
  .lead,.card,.case,.footer-cta{border-radius:18px;padding:20px}
  .lead{margin-top:-20px}
  .stats,.two-col,.grid-3,.case-grid{grid-template-columns:1fr}

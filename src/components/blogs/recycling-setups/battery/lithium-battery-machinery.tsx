  ...
  return (
    ...
    <div className="min-h-screen bg-[#0b1220] text-[#e5eefc] font-sans">
      <div className="max-w-6xl mx-auto px-4 md:px-6 py-6 md:py-12">
        ...
        {/* HERO */}
        <section className="hero relative overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#1e3a8a] to-[#0f766e] border border-[#38bdf8]/30 rounded-3xl p-6 md:p-10 md:p-16 mb-12">
          <div className="kicker inline-block bg-white/10 border border-white/20 text-[#d7f2ff] px-4 md:px-6 py-2 rounded-full text-sm font-medium mb-6 max-w-full break-words text-center">
          ...
          <p className="text-base md:text-xl max-w-3xl leading-relaxed opacity-90">
          ...
          <div className="flex flex-wrap gap-2 mt-8">
            <span className="pill px-3 py-2 bg-white/10 border border-white/20 rounded-full text-xs md:text-sm">Capacity planning</span>
            <span className="pill px-3 py-2 bg-white/10 border border-white/20 rounded-full text-xs md:text-sm">Safety-first operations</span>
            <span className="pill px-3 py-2 bg-white/10 border border-white/20 rounded-full text-xs md:text-sm">Higher recovery</span>
          </div>
        </section>
        ...
        <div className="lg:flex lg:gap-10 lg:items-start">
          ...
          <div className="flex-1 space-y-12 overflow-hidden">
            ...
            <div className="grid gap-8">
              ...
              <div className="card bg-[#121c31] border border-[#23304a] rounded-3xl p-5 md:p-10">
                <h2 className="text-xl md:text-3xl font-bold mb-6 break-words">How we help clients with machinery</h2>
                <p className="text-[#9fb0cf] mb-8 text-sm md:text-base">
                ...
                <h3 className="font-semibold text-lg md:text-xl mb-4">We support with:</h3>
                <ul className="space-y-3 text-[#9fb0cf] text-sm md:text-base">
                  {[
                ...
                <div className="mt-10 bg-[#0f172a] border border-[#38bdf8]/30 rounded-2xl p-6 text-sm md:text-base">
              ...
              <div className="card bg-[#121c31] border border-[#23304a] rounded-3xl p-5 md:p-10">
                <h2 className="text-xl md:text-3xl font-bold mb-6 break-words">Performance Comparison</h2>
                <p className="text-[#9fb0cf] mb-8 text-sm md:text-base">A simple view of how the right machinery setup changes plant performance.</p>
            ...
            {/* Practical Points */}
            <div className="card bg-[#121c31] border border-[#23304a] rounded-3xl p-5 md:p-10">
              <h2 className="text-xl md:text-3xl font-bold mb-6 break-words">Practical points clients usually ask about</h2>
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  ...
                  <div key={i} className="bg-[#0f172a] border border-[#23304a] rounded-2xl p-5">
                    <div className="text-xl md:text-3xl font-bold text-[#38bdf8] mb-3">{item.num}</div>
                    <div className="text-[#9fb0cf] text-sm md:text-base">{item.label}</div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid gap-8">
              {/* Workflow */}
              <div className="card bg-[#121c31] border border-[#23304a] rounded-3xl p-5 md:p-10">
                <h2 className="text-xl md:text-3xl font-bold mb-6 break-words">How the Machinery Workflow Works</h2>
                <div className="flex flex-wrap gap-2 mb-8">
                  {["Raw battery input", "Safe dismantling", "Shredding / crushing", "Sorting & separation", "Recovered material output"].map((step, i) => (
                    <div key={i} className="bg-[#0f172a] border border-[#23304a] px-4 py-2.5 rounded-full text-xs md:text-sm font-medium">
                      {step}
                    </div>
                  ))}
                </div>

                <h3 className="font-semibold text-base md:text-xl mb-4 break-words">Suggested Machinery Database</h3>
                  ...
                  <table className="w-full min-w-[500px] text-xs md:text-sm">
                    <thead>
                      <tr className="bg-[#0f172a]">
                        ...
                        <th className="text-left p-4 font-semibold">Main Benefit</th>
                      </tr>
                    </thead>
                    <tbody className="text-[#9fb0cf]">
                      <tr className="border-t border-[#23304a]"><td className="p-4 font-medium text-white">Dismantling station</td><td className="p-4">Safe opening of packs</td><td className="p-4">Reduces risk</td></tr>
                      <tr className="border-t border-[#23304a]"><td className="p-4 font-medium text-white">Shredder / crusher</td><td className="p-4">Breaks material</td><td className="p-4">Improves speed</td></tr>
                      <tr className="border-t border-[#23304a]"><td className="p-4 font-medium text-white">Separation unit</td><td className="p-4">Sorts metals & black mass</td><td className="p-4">Raises recovery</td></tr>
                      <tr className="border-t border-[#23304a]"><td className="p-4 font-medium text-white">Dust collection system</td><td className="p-4">Controls particles</td><td className="p-4">Improves safety</td></tr>
                    </tbody>
                  </table>
                </div>
              </div>
              ...
              {/* Case Study */}
              <div className="card bg-[#121c31] border-l-4 border-[#22c55e] rounded-3xl p-5 md:p-10">
                <h2 className="text-xl md:text-3xl font-bold mb-6 break-words">Case Study: Mid-size Recycler in Gujarat</h2>
                <div className="space-y-6 text-[#9fb0cf] text-sm md:text-base">
            ...
            {/* Final Thought */}
            <div className="footer bg-gradient-to-br from-[#22c55e]/10 to-[#38bdf8]/10 border border-[#23304a] rounded-3xl p-6 md:p-10 text-center">
              <p className="text-base md:text-xl font-semibold mb-4 break-words">
                In lithium-ion battery recycling, machinery is the backbone of the plant.
              </p>
              <p className="text-[#9fb0cf] text-sm md:text-base max-w-3xl mx-auto">
                When the setup is right, the business becomes safer, faster, and more profitable.
              </p>
              <p className="mt-8 text-[#38bdf8] font-medium text-sm md:text-base">Partner with us to build a recycling plant that works smoothly from day one.</p>
            </div>

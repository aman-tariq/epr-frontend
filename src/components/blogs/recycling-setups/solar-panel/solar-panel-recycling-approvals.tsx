    ...
    <div className="blog-container w-full max-w-full font-['Poppins'] bg-gradient-to-b from-[#fff7ed] via-[#f8fafc] to-[#f4f7fb] text-[#1f2937] pb-12">
      ...
      <section className="hero relative overflow-hidden bg-gradient-to-br from-[#111827] via-[#0f766e] to-[#f59e0b] text-white rounded-[30px] px-6 md:px-12 py-16 md:py-20 mx-4 my-6 shadow-2xl">
        ...
        <div className="hero-inner relative z-10 text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-6xl font-extrabold leading-tight mb-6 break-words">
          ...
          <div className="hero-quote mt-8 text-lg md:text-xl font-semibold break-words">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <main className="lg:col-span-2 w-full min-w-0 flex flex-col gap-8">
          ...
          <section className="card bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-[#e5e7eb]">
            <h2 className="text-2xl md:text-3xl font-bold mb-5 text-[#0f172a]">Why approvals matter before plant setup</h2>
            ...
            <div className="highlight mt-6 bg-amber-50 border-l-4 border-amber-500 rounded-xl p-5">
            ...
            <div className="pill-row flex flex-wrap gap-2 mt-6">
              <span className="pill px-4 py-2 text-xs md:text-sm font-semibold rounded-full bg-[#fef3c7] border border-[#fcd34d] text-[#92400e]">Environmental compliance</span>
              <span className="pill px-4 py-2 text-xs md:text-sm font-semibold rounded-full bg-[#fef3c7] border border-[#fcd34d] text-[#92400e]">Safe material recovery</span>
              <span className="pill px-4 py-2 text-xs md:text-sm font-semibold rounded-full bg-[#fef3c7] border border-[#fcd34d] text-[#92400e]">Investor confidence</span>
              <span className="pill px-4 py-2 text-xs md:text-sm font-semibold rounded-full bg-[#fef3c7] border border-[#fcd34d] text-[#92400e]">Faster launch readiness</span>
            </div>
          </section>
          ...
          <div className="block lg:hidden w-full">
            <div className="bg-white rounded-3xl p-6 shadow-xl border border-[#e5e7eb]">
              <h3 className="text-xl font-bold mb-2 text-[#0f172a]">Connect With Our Experts</h3>
              <p className="text-xs text-slate-500 mb-4">Have questions regarding approvals or your solar recycling roadmap?</p>
              <StickyContactForm />
            </div>
          </div>
          ...
          <section className="card bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-[#e5e7eb]">
            <h2 className="text-2xl md:text-3xl font-bold mb-5 text-[#0f172a]">What a client should know first</h2>
            <p className="text-[#5b6472] mb-4">
            ...
            <div className="highlight bg-amber-50 border-l-4 border-amber-500 rounded-xl p-5">
            ...
            <p className="note mt-4 text-sm text-slate-500 italic">
          ...
          <section className="card bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-[#e5e7eb]">
            <h2 className="text-2xl md:text-3xl font-bold mb-5 text-[#0f172a]">Major approvals required for a solar panel recycling plant</h2>
            ...
            <div className="table-wrap overflow-x-auto rounded-2xl border border-[#e5e7eb] w-full">
              <table className="w-full table-auto min-w-full">
                <thead>
                  <tr className="bg-[#0f172a] text-white">
                    <th className="text-left px-4 py-4 text-sm font-semibold min-w-[140px]">Approval</th>
                    <th className="text-left px-4 py-4 text-sm font-semibold min-w-[180px]">Why it is needed</th>
                    <th className="text-left px-4 py-4 text-sm font-semibold min-w-[150px]">What it protects</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-[#e5e7eb]">
                  {[
                    ...
                    <tr key={i} className="hover:bg-[#fffaf0] transition-colors">
                      <td className="px-4 py-4 text-sm font-semibold break-words whitespace-normal text-slate-900 max-w-[160px]">{approval}</td>
                      <td className="px-4 py-4 text-sm text-[#5b6472] break-words whitespace-normal max-w-[220px]">{why}</td>
                      <td className="px-4 py-4 text-sm text-[#5b6472] break-words whitespace-normal max-w-[180px]">{protect}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          {/* Complete Checklist */}
          <section className="card bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-[#e5e7eb]">
            <h2 className="text-2xl md:text-3xl font-bold mb-5 text-[#0f172a]">Licences & approvals — the complete checklist</h2>
            ...
            <div className="checklist-grid grid grid-cols-1 sm:grid-cols-2 gap-5">
              {[
                ...
                <div key={i} className="check-card border border-[#e5e7eb] rounded-2xl p-6 bg-gradient-to-b from-white to-[#fffbeb] flex flex-col justify-between">
                  <div>
                    <div className="flex items-center gap-3 mb-3">
                      <div className="check-num w-8 h-8 shrink-0 rounded-full bg-gradient-to-br from-[#0f172a] to-[#f59e0b] text-white font-bold flex items-center justify-center text-sm">
                        {item.num}
                      </div>
                      <h4 className="font-semibold text-base text-slate-900 break-words">{item.title}</h4>
                    </div>
                    <p className="text-[#5b6472] text-xs md:text-sm leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          {/* Roadmap Steps */}
          <section className="card bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-[#e5e7eb]">
            <h2 className="text-2xl md:text-3xl font-bold mb-5 text-[#0f172a]">The approval roadmap in simple steps</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {[
                ...
                <div key={i} className="step border border-[#e5e7eb] rounded-2xl p-5 bg-gradient-to-b from-[#fffdf7] to-white">
                  ...
                  <h4 className="font-semibold text-base mb-2 text-slate-900 break-words">{step.title}</h4>
          ...
          <div className="grid grid-cols-1 gap-6">
            <section className="card bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-[#e5e7eb]">
              <h2 className="text-xl md:text-2xl font-bold mb-4 text-slate-900">Bar graph: where the approval effort is highest</h2>
              <p className="text-[#5b6472] mb-6 text-sm md:text-base">This chart helps clients understand which permissions usually need the most planning.</p>
              <div className="bars space-y-5">
                {[
                  ...
                  <div key={i} className="bar-item flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="bar-label text-sm font-medium text-slate-800 sm:w-[220px] break-words">{bar.label}</div>
                    ...
                    <div className="bar-value font-bold text-sm text-slate-900 sm:w-[50px] text-right shrink-0">{bar.value}</div>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section className="card bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-[#e5e7eb]">
              <h2 className="text-xl md:text-2xl font-bold mb-4 text-slate-900">Project readiness score</h2>
              <p className="text-[#5b6472] mb-6 text-sm md:text-base">A simple database-style view helps clients see whether the project is ready.</p>
              <div className="mini-database grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="db-box border border-[#e5e7eb] rounded-2xl p-5 bg-slate-50">
                    <h4 className="font-semibold text-base mb-2 text-slate-900 break-words">{item.title}</h4>
                    <p className="text-xs md:text-sm text-[#5b6472] leading-relaxed">{item.desc}</p>
                  </div>
                ))}
              </div>
            </section>
          ...
          {/* Additional Topics */}
          <section className="card bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-[#e5e7eb]">
            <h2 className="text-2xl md:text-3xl font-bold mb-5 text-[#0f172a]">Additional topics that help the client understand the project better</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold text-lg md:text-xl mb-2 text-slate-900 break-words">1. Plant layout and approval connection</h3>
                <p className="text-sm text-[#5b6472] leading-relaxed">The layout should already reflect the approval expectations.</p>
                <h3 className="font-semibold text-lg md:text-xl mt-6 mb-2 text-slate-900 break-words">2. Document checklist</h3>
                <p className="text-sm text-[#5b6472] leading-relaxed">A complete document set makes approvals smoother.</p>
              </div>
              <div>
                <h3 className="font-semibold text-lg md:text-xl mb-2 text-slate-900 break-words">3. Risk if approvals are delayed</h3>
                <p className="text-sm text-[#5b6472] leading-relaxed">Delays can affect machinery installation and commercial launch.</p>
                <h3 className="font-semibold text-lg md:text-xl mt-6 mb-2 text-slate-900 break-words">4. Why compliance builds trust</h3>
                <p className="text-sm text-[#5b6472] leading-relaxed">Buyers, partners, and investors trust a plant more when compliance is clear.</p>
              </div>
            </div>
            <div className="highlight mt-8 bg-amber-50 border-l-4 border-amber-500 rounded-xl p-5">
          ...
          <section className="card case-study bg-gradient-to-br from-[#fff7ed] to-[#ffedd5] border border-[#fdba74] rounded-3xl p-6 md:p-8 shadow-xl">
            <h2 className="text-2xl md:text-3xl font-bold mb-5 text-[#9a3412]">Case study: how proper approvals strengthened a solar recycling project</h2>
            <p className="text-sm md:text-base text-[#6b4b21] mb-6">
            ...
            <div className="case-grid grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                ...
                <div key={i} className="case-item bg-white border border-[#fed7aa] rounded-2xl p-5 flex flex-col justify-between">
                  <div>
                    <h4 className="font-semibold text-base mb-3 text-amber-900 break-words">{item.title}</h4>
                    <p className="text-xs md:text-sm text-[#6b4b21] leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <section className="card bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-[#e5e7eb]">
            ...
            <div className="faq space-y-4">
              {[
                ...
                <div key={i} className="faq-item border border-[#e5e7eb] rounded-2xl p-5">
                  <h4 className="font-semibold text-base mb-2 text-slate-900 break-words">{faq.q}</h4>
                  <p className="text-xs md:text-sm text-[#5b6472] leading-relaxed">{faq.a}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="closing text-grey-900 text-center py-12 px-4 rounded-[30px]">
            ...
            <div className="final-line mt-10 text-xl md:text-3xl font-bold break-words">“Strong approvals create stronger solar recycling businesses.”</div>
          </section>
        </main>

        {/* RIGHT COLUMN: DESKTOP STICKY SIDEBAR */}
        {/* Added "sticky top-28 self-start" for guaranteed sliding behavior inside the grid layout */}
        <aside className="hidden lg:block lg:col-span-1 sticky top-28 self-start h-fit will-change-transform z-30 w-full min-w-0 bg-white p-6 rounded-[26px] shadow-xl border border-gray-200">
          <h3 className="text-xl font-bold mb-2 text-[#0f172a]">Connect With Our Experts</h3>
          <p className="text-sm text-slate-500 mb-6">Have questions regarding approvals or your solar recycling roadmap?</p>
          <StickyContactForm />
        </aside>

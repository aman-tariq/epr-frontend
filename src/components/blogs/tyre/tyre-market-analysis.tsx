  ...
  return (
    ...
    <div className="min-h-screen bg-[#07111f] text-[#eef5ff] font-sans">
      ...
      <section id="market-size" className="max-w-6xl mx-auto px-6 py-20">
        <h2 className="text-lg md:text-4xl md:text-5xl font-bold mb-4">Understanding the Size and Shape of the Tyre Recycling Market</h2>
        ...
        <div className="grid md:grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          {[
...
<section id="case-study" className="max-w-6xl mx-auto px-6 py-20">
  <div className="text-center mb-12">
    <h2 className="text-lg md:text-4xl md:text-5xl font-bold mb-6 leading-tight">
...
<section className="max-w-6xl mx-auto px-6 py-20 bg-[#0c1830]">
  <div className="text-center mb-12">
    <h2 className="text-lg md:text-4xl md:text-5xl font-bold mb-4">What Clients Gain From a Proper Market Analysis</h2>
...
<section id="faq" className="max-w-6xl mx-auto px-6 py-20">
  <div className="text-center mb-12">
    <h2 className="text-lg md:text-4xl md:text-5xl font-bold mb-4">Frequently Asked Questions</h2>

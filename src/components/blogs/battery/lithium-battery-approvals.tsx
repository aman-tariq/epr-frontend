...
const LithiumBatteryApprovals: React.FC = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#050E09] text-[#E1F5EE] font-sans">
      {/* HERO */}
      <div className="hero bg-[#050E09] border border-[#1D9E75]/30 rounded-3xl p-2 md:p-8 md:p-12 mx-4 md:mx-auto max-w-5xl mt-8 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-2 md:px-6 py-6 md:py-12 space-y-20">
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 md:grid-cols-4 gap-6 mb-10 mx-2">
            {[
       ...
       {/* ==================== CASE STUDY SECTION ==================== */}
<section className="max-w-5xl mx-auto px-2 md:px-6 py-6 md:py-16">
  ...
  <div className="bg-white/5 border border-[#1D9E75] rounded-3xl overflow-hidden mb-12">
    {/* Header */}
    <div className="bg-gradient-to-r from-[#063D30] to-[#0F6E56] p-2 md:p-8 md:p-10">
    ...
    {/* Body */}
    <div className="p-2 md:p-8 md:p-10 space-y-10">
      {/* Stats */}
  ...
  {/* Urgency Box */}
  <div className="bg-gradient-to-br from-[#FEF3C7] to-[#FDE68A] border border-[#F59E0B] rounded-3xl p-2 md:p-8 md:p-10 md:flex gap-6 text-[#78350F]">

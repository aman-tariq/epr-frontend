  ...
  return (
    ...
    <div className="min-h-screen bg-[#07111f] text-[#e8f0ff] font-sans">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        {/* HERO */}
        <div className="hero bg-gradient-to-br from-[#0f1c33] to-[#111f38] border border-[#38bdf8]/30 rounded-3xl p-2 md:p-10 md:p-16 mb-12">
          <div className="badge inline-block bg-[#38bdf8]/10 border border-[#38bdf8]/30 text-[#38bdf8] px-6 py-2 rounded-full text-sm font-medium mb-6">
            🔋 Recycling Market View | Present Batteries First
          </div>
          <h1 className="text-2xl md:text-5xl font-bold leading-tight mb-8">
            Market Analysis of Mobile, E-Rickshaw and Car Batteries in Recycling
          </h1>
          <p className="text-[#d1e2ff] text-lg max-w-3xl">
        ...
        <div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10 mb-12">
          <h2 className="text-xl md:text-3xl font-bold mb-6">What This Market Looks Like Today</h2>
          ...
          <div className="grid md:grid-cols-4 gap-6 mt-10">
            {[
              ...
              <div key={i} className="bg-[#111f38] border border-[#223453] rounded-2xl p-6 text-center">
                <div className="text-2xl font-bold text-[#38bdf8] mb-2">{stat.num}</div>
...
<div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10 mb-12">
  <h2 className="text-xl md:text-3xl font-bold mb-8 text-center md:text-left">Quick Visual Dashboard</h2>
  <p className="text-[#a8b6d3] mb-8 text-center md:text-left">A fast view of the three current battery streams and the future EV plan.</p>

  <div className="space-y-12">
    
    {/* Present Collection Strength */}
    <div>
      <h3 className="text-xl font-semibold mb-4 text-center md:text-left">Present Collection Strength</h3>
      <div className="bg-[#111f38] rounded-2xl p-4 md:p-6">
        <div className="h-64 md:h-72">
          <canvas id="presentStrengthChart" className="w-full h-full" />
        </div>
      </div>
    </div>
    ...
    <div>
      <h3 className="text-xl font-semibold mb-4 text-center md:text-left">Collection Source Mix</h3>
      <div className="bg-[#111f38] rounded-2xl p-4 md:p-6">
        <div className="flex justify-center">
          <div className="w-full max-w-[300px] md:max-w-[340px]">
            <canvas id="sourceMixChart" className="w-full h-full" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      <h3 className="text-xl font-semibold mb-4 text-center md:text-left">Future Readiness Roadmap</h3>
      <div className="bg-[#111f38] rounded-2xl p-4 md:p-6">
        <div className="h-52 md:h-64">
          <canvas id="futureRoadmapChart" className="w-full h-full" />
        </div>
      </div>
    </div>
  </div>
...
<div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10 mb-8">
  <h2 className="text-xl md:text-3xl font-bold mb-6">Market Profile of the Three Current Battery Types</h2>
...
<div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10 mb-12">
  <h2 className="text-xl md:text-3xl font-bold mb-6">Database: Present Battery Segments</h2>
  
  <div className="overflow-x-auto rounded-2xl border border-[#223453]">
    <table className="w-full min-w-full">
      <thead>
        <tr className="bg-[#111f38]">
          <th className="text-left p-4 font-medium">Battery type</th>
          <th className="text-left p-4 font-medium">Main source</th>
          <th className="text-left p-4 font-medium">Collection cycle</th>
          <th className="text-left p-4 font-medium">Business priority</th>
        </tr>
      </thead>
      <tbody className="text-[#a8b6d3] divide-y divide-[#223453]">
        <tr>
          <td className="p-4 font-medium">Mobile batteries</td>
          <td className="p-4">Consumers, repair shops</td>
          <td className="p-4">Small packs, frequent</td>
          <td className="p-4"><span className="bg-emerald-900/80 text-emerald-400 px-4 py-1 rounded-full text-xs font-medium">Very High</span></td>
        </tr>
        <tr>
          <td className="p-4 font-medium">E-rickshaw batteries</td>
          <td className="p-4">Fleet operators, charging points</td>
          <td className="p-4">Regular replacement cycle</td>
          <td className="p-4"><span className="bg-emerald-900/80 text-emerald-400 px-4 py-1 rounded-full text-xs font-medium">Very High</span></td>
        </tr>
        <tr>
          <td className="p-4 font-medium">Car batteries</td>
        ...
        {/* Mobile, E-Rickshaw, Car Batteries Details */}
        <div className="grid md:grid-cols-1 gap-8 mb-12">
          <div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10">
            <h2 className="text-xl md:text-3xl font-bold mb-6">Mobile Batteries: The Small but Steady Stream</h2>
            <p className="text-[#a8b6d3] mb-6">
            ...
            <div className="bg-[#111f38] rounded-2xl p-6">
              <strong>Best collection source:</strong> Repair shops<br />
              <strong>Planning value:</strong> Steady volume
            </div>
          </div>

          <div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10">
            <h2 className="text-xl md:text-3xl font-bold mb-6">E-Rickshaw Batteries: The City Market Opportunity</h2>
            <p className="text-[#a8b6d3] mb-6">
            ...
            <div className="bg-[#111f38] rounded-2xl p-6">
              <strong>Best collection source:</strong> Fleet operators<br />
              <strong>Planning value:</strong> Repeatable source
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10">
            <h2 className="text-xl md:text-3xl font-bold mb-6">Car Batteries: The Structured Replacement Channel</h2>
            <p className="text-[#a8b6d3]">
          ...
          <div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10">
            <h2 className="text-xl md:text-3xl font-bold mb-6">How the Plant Should Position Itself</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10">
            <h2 className="text-xl md:text-3xl font-bold mb-6">Case Study: City Collection Network</h2>
            <p className="text-[#a8b6d3]">
          ...
          <div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10">
            <h2 className="text-xl md:text-3xl font-bold mb-6">Future Plan: EV Battery Readiness</h2>
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="bg-[#111f38] border border-[#223453] rounded-2xl p-4 text-center">
                  <div className="text-sm text-[#38bdf8]">{item.phase}</div>
        ...
        {/* Quick Database */}
        <div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10 mb-12">
          <h2 className="text-xl md:text-3xl font-bold mb-6">Quick Database: Market Action Plan</h2>
          <div className="overflow-x-auto rounded-2xl border border-[#223453]">
            <table className="w-full">
              <thead>
                <tr className="bg-[#111f38]">
                  <th className="text-left p-4">Focus area</th>
                  <th className="text-left p-4">Current action</th>
                  <th className="text-left p-4">Future benefit</th>
                </tr>
              </thead>
              <tbody className="text-[#a8b6d3]">
                <tr className="border-t border-[#223453]"><td className="p-4">Mobile batteries</td><td className="p-4">Build shop-level collection</td><td className="p-4">Stable daily feedstock</td></tr>
                <tr className="border-t border-[#223453]"><td className="p-4">E-rickshaw batteries</td><td className="p-4">Sign fleet tie-ups</td><td className="p-4">Recurring bulk returns</td></tr>
                <tr className="border-t border-[#223453]"><td className="p-4">Car batteries</td><td className="p-4">Link garages</td><td className="p-4">Structured inflow</td></tr>
                <tr className="border-t border-[#223453]"><td className="p-4">EV readiness</td><td className="p-4">Plan safety & logistics</td><td className="p-4">Future growth capacity</td></tr>
              </tbody>
            </table>
          </div>
        </div>
        ...
        {/* Conclusion */}
        <div className="card bg-[#0f1c33] border border-[#223453] rounded-3xl p-2 md:p-10 text-center">
          <h2 className="text-xl md:text-3xl font-bold mb-6">Conclusion</h2>
          <p className="text-[#a8b6d3] max-w-3xl mx-auto">

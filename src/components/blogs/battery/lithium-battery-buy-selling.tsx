  ...
  return (
    ...
    <div className="min-h-screen bg-[#f8fafc] text-[#1f2937] font-sans pb-12">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-16">
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm">
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={i} className="flex gap-3 text-[#1f2937]">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="h-5 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-emerald-600 to-teal-500 rounded-full" style={{ width: '77%' }}></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="h-5 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-emerald-600 to-teal-500 rounded-full" style={{ width: '100%' }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-sm">
            ...
            <div className="flex flex-wrap gap-3">
              {["Seller Inquiry", "Material Review", "Price Benchmarking", "Buyer Matching", "Deal Closure", "Logistics Support"].map((step, i) => (
                <div key={i} className="bg-sky-50 border border-sky-200 px-5 py-3 rounded-full text-sm">
                  {step}
                </div>
              ))}
            </div>
            ...
            <div className="mt-10 bg-amber-50 border border-amber-100 rounded-2xl p-6">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="h-4 bg-gray-200 rounded-full"><div className="h-full bg-amber-500 rounded-full w-[55%]"></div></div>
                </div>
                <div>
                  <div className="flex justify-between mb-1 text-sm"><span>After</span><span>₹8L</span></div>
                  <div className="h-4 bg-gray-200 rounded-full"><div className="h-full bg-emerald-500 rounded-full w-[88%]"></div></div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Final CTA */}
        <div className="footer-cta bg-gradient-to-br from-[#0f172a] to-[#1e3a8a] text-white rounded-3xl p-12 text-center">

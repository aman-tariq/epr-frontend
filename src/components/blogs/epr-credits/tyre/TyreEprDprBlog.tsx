...
const TyreEprDprBlog = () => {
  return (
    <div className="prose prose-slate max-w-none px-4 py-6 md:px-8">
      <h2 className="text-2xl font-bold text-foreground mb-4">EPR Tyre Credits: Detailed Project Report (DPR) Essentials</h2>
      <p className="text-muted-foreground leading-8">
        Our team is currently putting together a full, detailed article on{" "}
        EPR tyre detailed project report (dpr) essentials. It will cover the practical steps,

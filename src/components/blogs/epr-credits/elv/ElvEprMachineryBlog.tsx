...
const ElvEprMachineryBlog = () => {
  return (
    <div className="prose prose-slate max-w-none px-4 py-6 md:px-8">
      <h2 className="text-2xl font-bold text-foreground mb-4">EPR ELV Credits: Machinery, Setup & Operations Guide</h2>
      <p className="text-muted-foreground leading-8">
        Our team is currently putting together a full, detailed article on{" "}
        EPR end-of-life vehicle (ELV) machinery, setup & operations guide. It will cover the practical steps,
...
export default ElvEprMachineryBlog;

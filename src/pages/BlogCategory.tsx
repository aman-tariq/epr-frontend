...
const BlogCategoryPage = () => {
  ...
  const matchCategory = post.category === categoryData.slug; // ✅ fixed
  if (subcategory) {
    return matchCategory && post.category === subcategory;   // ✅ fixed
  }
  ...
  return (
    <>
      <Seo
        ...
        description={subcategory ? subcategoryDescriptions[subcategory] ?? categoryData.description : categoryData.description}
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          >
            ...
            <h1 className="mt-6 text-5xl lg:text-6xl font-bold leading-tight">
              {subcategory ? subcategoryLabels[subcategory] : `${categoryData.name} Blog`}
            </h1>
            <p className="mt-6 max-w-2xl text-white/80 text-lg leading-relaxed">
              {subcategory ? subcategoryDescriptions[subcategory] ?? categoryData.description : categoryData.description}
            </p>

...
const BlogPost = () => {
  ...
  const MappedComponent = blogComponents[post.slug];
            ...
            <div className="grid gap-10 lg:grid-cols-[1.85fr_0fr] min-w-0">
              <main className="space-y-10 min-w-0">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="rounded-[2rem] border border-border bg-card p-8 shadow-lg shadow-secondary/5 min-w-0"
                >
                ...
                {MappedComponent ? (
                  <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="rounded-[2rem] border border-border bg-card p-2 shadow-lg shadow-secondary/5 min-w-0"
                  >
                    <MappedComponent />
                  </motion.div>
                ) : post.fullContent ? (
                  <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    className="rounded-[2rem] border border-border bg-card shadow-lg shadow-secondary/5 min-w-0"
